...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(
		...
		array(
			'id'       => 'header-content',
			'type'     => 'select',
			'title'    => __( 'Select Header Template', 'redux-framework-demo' ),
			'desc'     => __( '', 'redux-framework-demo' ),
			'options'  => array(
				'1' => 'Text Content',
				'2' => 'Lead Form',
		...
		array(
			...
			'type'     => 'media',
			'url'      => true,
			'required' => array( 'header-content','equals','1' ),
		...
		array(
			...
			'type'     => 'media',
			'url'      => true,
			'required' => array( 'header-content','equals','2' ),
		...
		array(
			...
			'type'     => 'media',
			'url'      => true,
			'required' => array( 'header-content','equals','3' ),
			'title'    => __( 'Thank You Image', 'redux-framework-demo' ),
			'desc'     => __( 'Thank You Image', 'redux-framework-demo' ),
			'subtitle' => __( '', 'redux-framework-demo' ),
			'default'  => array( 'url' => 'http://s.wordpress.org/style/images/codeispoetry.png' ),
		),
	)
